    ...
    fun getVisitorOnMatchingMethod() = rewriteRun(
            ...
            """,
                ...
                class Test {
                  ...
                  org.openrewrite.java.RecipeExceptionDemonstration${'$'}4.visitMethodInvocation(RecipeExceptionDemonstration.java:139)
                  org.openrewrite.java.RecipeExceptionDemonstration${'$'}4.visitMethodInvocation(RecipeExceptionDemonstration.java:133))~~>*/list.add(42);
                    }
                }
            """
            )
    ...
    fun applicableTestVisitor() = rewriteRun(
            ...
            java(
                ...
                """,
                    """
                    /*~~(org.openrewrite.java.RecipeExceptionDemonstration${'$'}DemonstrationException: Throwing on the project-level applicable test.
                      org.openrewrite.java.RecipeExceptionDemonstration${'$'}1.preVisit(RecipeExceptionDemonstration.java:77)
                      org.openrewrite.java.RecipeExceptionDemonstration${'$'}1.preVisit(RecipeExceptionDemonstration.java:74))~~>*/import java.util.*;
                    class Test {
                        void test(List<Integer> list) {
                            list.add(42);
                        }
            ...
            java(
                ...
                """,
                    ...
                    /*~~(org.openrewrite.java.RecipeExceptionDemonstration${'$'}DemonstrationException: Demonstrating an exception thrown in the recipe's `visit(List<SourceFile>, ExecutionContext)` method.
                      org.openrewrite.java.RecipeExceptionDemonstration${'$'}3.preVisit(RecipeExceptionDemonstration.java:119)
                      org.openrewrite.java.RecipeExceptionDemonstration${'$'}3.preVisit(RecipeExceptionDemonstration.java:116))~~>*/import java.util.*;
                    class Test {
                        void test(List<Integer> list) {
                            list.add(42);
                        }
