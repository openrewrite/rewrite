...
public class HCLParser extends Parser {
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1112L) != 0)) {
				{
				{
				setState(88);
				bodyContent();
	...
	public final ObjectContext object() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17297540350L) != 0)) {
				{
				{
				setState(187);
				objectelem();
	...
	public static class QualifiedIdentifierContext extends ParserRuleContext {
		...
		public List<TerminalNode> IF() { return getTokens(HCLParser.IF); }
		public TerminalNode IF(int i) {
			return getToken(HCLParser.IF, i);
		}
		public List<TerminalNode> IN() { return getTokens(HCLParser.IN); }
		public TerminalNode IN(int i) {
			return getToken(HCLParser.IN, i);
		}
