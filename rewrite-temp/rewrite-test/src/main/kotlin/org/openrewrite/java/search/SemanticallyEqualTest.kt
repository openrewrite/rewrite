...
interface SemanticallyEqualTest {
    ...
    fun fieldAccessEquality(jp: JavaParser) {
        ...
        assertThat(
            SemanticallyEqual(annotFieldAccess)
                .visit(
                    J.FieldAccess(
                        randomId(),
                        J.Ident.build(
                            randomId(),
                            "FastTest",
                            JavaType.buildType("FastTest"),
                            emptyList(),
                            Formatting.EMPTY,
                            Markers.EMPTY
                        ),
                        J.Ident.build(randomId(), "class", null, emptyList(), Formatting.EMPTY, Markers.EMPTY),
