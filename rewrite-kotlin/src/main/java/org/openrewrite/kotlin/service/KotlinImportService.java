...
public class KotlinImportService extends ImportService {
    ...
    @Override
    public <P> JavaVisitor<P> addImportVisitor(@Nullable String packageName, String typeName, @Nullable String member, boolean __, @Nullable String alias, boolean onlyIfReferenced) {
