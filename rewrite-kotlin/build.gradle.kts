...
val generateCompilerVersion by tasks.registering {
    val outputDir = generatedCompilerVersionDir
    val version = kotlinVersion
    inputs.property("kotlinVersion", version)
    outputs.dir(outputDir)
    doLast {
        outputDir.get().file("org/openrewrite/kotlin/recipe/internal/BuiltAgainstKotlinVersion.kt").asFile.apply {
            parentFile.mkdirs()
            writeText(
                """
                /*
                 * Copyright 2026 the original author or authors.
                 * Generated by the rewrite-kotlin `generateCompilerVersion` Gradle task — do not edit.
                 */
                package org.openrewrite.kotlin.recipe.internal

                internal const val BUILT_AGAINST_KOTLIN_VERSION: String = "$version"
...
sourceSets.named("main") {
    java.srcDir(generateCompilerVersion)
}
