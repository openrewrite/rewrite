...
public class Parser {
    ...
    public Tr.CompilationUnit parse(String source, String whichDependsOn) {
        return parse(source, singletonList(whichDependsOn));
    }

    public Tr.CompilationUnit parse(String source, List<String> whichDependOn) {
        return parse(source, whichDependOn.toArray(String[]::new));
    }

    public List<Tr.CompilationUnit> parse(List<Path> sourceFiles) {
        return parse(sourceFiles, null);
    }

    public Tr.CompilationUnit parse(String source, String... whichDependOn) {
        try {
