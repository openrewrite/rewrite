...
public class AppendToTextFile extends ScanningRecipe<AtomicBoolean> {
    ...
    String displayName = "Append to text file";

    String description = "Appends or replaces content of an existing plain text file, or creates a new one if it doesn't already exist. " +
