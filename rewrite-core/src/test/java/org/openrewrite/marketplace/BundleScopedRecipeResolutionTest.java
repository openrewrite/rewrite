...
class BundleScopedRecipeResolutionTest implements RewriteTest {
    ...
    /**
     * Install a listing for the Spring recipe and nothing below it, exactly as the marketplace would
     * look when the Elastic recipe reaches the Spring bundle as a transitive dependency, then
    ...
    private static Recipe prepareUserRecipe() {
        ...
        Collection<RecipeBundleResolver> resolvers = List.of(new SpringBundleResolver());
