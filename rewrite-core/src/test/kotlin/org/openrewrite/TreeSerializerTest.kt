...
class TreeSerializerTest {
    ...
    fun serializeStyle() {
        ...
        val plainText1 = PlainText(Tree.randomId(), Markers.build(listOf(styles)), "hi Jon")
        val plainText2 = PlainText(Tree.randomId(), Markers.build(listOf(styles)), "hi Jonathan")
