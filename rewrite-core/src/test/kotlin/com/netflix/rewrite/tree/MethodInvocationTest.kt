...
open class MethodInvocationTest : Parser() {
    ...
    private val allInvs by lazy { a.fields(0..4).map { it.vars[0].initializer as Tr.MethodInvocation } }
    ...
    fun genericMethodInvocation() {
        listOf(genericInv, explicitGenericInv).forEach { test: Tr.MethodInvocation ->
            // check assumptions about the call site
    ...
    fun methodThatDoesNotExist() {
        ...
        val inv = a.classes[0].fields[0].vars[0].initializer as Tr.MethodInvocation
