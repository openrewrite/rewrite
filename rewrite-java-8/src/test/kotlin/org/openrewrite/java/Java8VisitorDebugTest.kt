...
@DebugOnly
@ExtendWith(JavaParserResolver::class)
class Java8AddOrUpdateAnnotationAttribute : Java8Test, AddOrUpdateAnnotationAttributeTest
...
@DebugOnly
@ExtendWith(JavaParserResolver::class)
class Java8ExplicitCharsetOnStringGetBytesTest : Java8Test, ExplicitCharsetOnStringGetBytesTest
...
@DebugOnly
@ExtendWith(JavaParserResolver::class)
class Java8DeimplementInterfaceTest : Java8Test, DeimplementInterfaceTest
...
@DebugOnly
@ExtendWith(JavaParserResolver::class)
class Java8SimplifyConsecutiveAssignmentsTest : Java8Test, SimplifyConsecutiveAssignmentsTest
