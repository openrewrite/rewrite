...
public class ScalaIsoVisitor<P> extends ScalaVisitor<P> {

    @Override
    public S.CompilationUnit visitCompilationUnit(S.CompilationUnit cu, P p) {
        return (S.CompilationUnit) super.visitCompilationUnit(cu, p);
    }

    @Override
    public S.TuplePattern visitTuplePattern(S.TuplePattern tuplePattern, P p) {
        return (S.TuplePattern) super.visitTuplePattern(tuplePattern, p);
    }

    @Override
    public S.Wildcard visitWildcard(S.Wildcard wildcard, P p) {
        return (S.Wildcard) super.visitWildcard(wildcard, p);
    }
