...
public interface XMLParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterComment(XMLParser.CommentContext ctx);
	/**
	 * Exit a parse tree produced by {@link XMLParser#comment}.
	 * @param ctx the parse tree
	 */
	void exitComment(XMLParser.CommentContext ctx);
	/**
	 * Enter a parse tree produced by {@link XMLParser#cdata}.
	 * @param ctx the parse tree
	 */
	void enterCdata(XMLParser.CdataContext ctx);
	/**
	 * Exit a parse tree produced by {@link XMLParser#cdata}.
	 * @param ctx the parse tree
	 */
	void exitCdata(XMLParser.CdataContext ctx);
	/**
