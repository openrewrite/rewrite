...
public class XMLParser extends Parser {
	...
	public static class PrologContext extends ParserRuleContext {
		...
		public List<PrologContentContext> prologContent() {
			return getRuleContexts(PrologContentContext.class);
		}
		public PrologContentContext prologContent(int i) {
			return getRuleContext(PrologContentContext.class,i);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class PrologContentContext extends ParserRuleContext {
		...
		public PrologContentContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_prologContent; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XMLParserListener ) ((XMLParserListener)listener).enterPrologContent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XMLParserListener ) ((XMLParserListener)listener).exitPrologContent(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof XMLParserVisitor ) return ((XMLParserVisitor<? extends T>)visitor).visitPrologContent(this);
			else return visitor.visitChildren(this);
		}
	}

	public final PrologContentContext prologContent() throws RecognitionException {
		PrologContentContext _localctx = new PrologContentContext(_ctx, getState());
		enterRule(_localctx, 4, RULE_prologContent);
		try {
			setState(59);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final XmldeclContext xmldecl() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_xmldecl);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final MiscContext misc() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_misc);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(75);
	...
	public final DoctypedeclContext doctypedecl() throws RecognitionException {
		...
		enterRule(_localctx, 10, RULE_doctypedecl);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
