...
public class XMLParser extends Parser {
	...
	public static final int
		...
		DTD_OPEN=13, TEXT=14, DTD_CLOSE=15, DTD_SUBSET_OPEN=16, DTD_S=17, DOCTYPE=18,
		DTD_SUBSET_CLOSE=19, MARKUP_OPEN=20, DTS_SUBSET_S=21, MARK_UP_CLOSE=22,
		MARKUP_S=23, MARKUP_TEXT=24, MARKUP_SUBSET=25, PI_S=26, PI_TEXT=27, CLOSE=28,
		SPECIAL_CLOSE=29, SLASH_CLOSE=30, S=31, DIRECTIVE_OPEN=32, DIRECTIVE_CLOSE=33,
		SLASH=34, EQUALS=35, STRING=36, Name=37;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SPECIAL_OPEN", "DTD_OPEN", "TEXT", "DTD_CLOSE", "DTD_SUBSET_OPEN", "DTD_S",
			"DOCTYPE", "DTD_SUBSET_CLOSE", "MARKUP_OPEN", "DTS_SUBSET_S", "MARK_UP_CLOSE",
			"MARKUP_S", "MARKUP_TEXT", "MARKUP_SUBSET", "PI_S", "PI_TEXT", "CLOSE",
	...
	public final IntsubsetContext intsubset() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1052692L) != 0)) {
				{
				setState(87);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
