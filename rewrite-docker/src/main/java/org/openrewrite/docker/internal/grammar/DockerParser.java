...
public class DockerParser extends Parser {
    ...
    public static class DockerfileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(DockerParser.EOF, 0);
        }
    ...
    public static class ParserDirectiveContext extends ParserRuleContext {
        public TerminalNode PARSER_DIRECTIVE() {
            return getToken(DockerParser.PARSER_DIRECTIVE, 0);
        }
    ...
    public static class FromInstructionContext extends ParserRuleContext {
        public TerminalNode FROM() {
            return getToken(DockerParser.FROM, 0);
        }
        ...
        public TerminalNode AS() {
            return getToken(DockerParser.AS, 0);
        }
    ...
    public static class RunInstructionContext extends ParserRuleContext {
        public TerminalNode RUN() {
            return getToken(DockerParser.RUN, 0);
        }
    ...
    public static class CmdInstructionContext extends ParserRuleContext {
        public TerminalNode CMD() {
            return getToken(DockerParser.CMD, 0);
        }
    ...
    public static class LabelInstructionContext extends ParserRuleContext {
        public TerminalNode LABEL() {
            return getToken(DockerParser.LABEL, 0);
        }
    ...
    public static class ExposeInstructionContext extends ParserRuleContext {
        public TerminalNode EXPOSE() {
            return getToken(DockerParser.EXPOSE, 0);
        }
    ...
    public static class EnvInstructionContext extends ParserRuleContext {
        public TerminalNode ENV() {
            return getToken(DockerParser.ENV, 0);
        }
    ...
    public static class AddInstructionContext extends ParserRuleContext {
        public TerminalNode ADD() {
            return getToken(DockerParser.ADD, 0);
        }
    ...
    public static class CopyInstructionContext extends ParserRuleContext {
        public TerminalNode COPY() {
            return getToken(DockerParser.COPY, 0);
        }
    ...
    public static class EntrypointInstructionContext extends ParserRuleContext {
        public TerminalNode ENTRYPOINT() {
            return getToken(DockerParser.ENTRYPOINT, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_entrypointInstruction;
        }
    ...
    public static class VolumeInstructionContext extends ParserRuleContext {
        public TerminalNode VOLUME() {
            return getToken(DockerParser.VOLUME, 0);
        }
    ...
    public static class UserInstructionContext extends ParserRuleContext {
        public TerminalNode USER() {
            return getToken(DockerParser.USER, 0);
        }
    ...
    public static class WorkdirInstructionContext extends ParserRuleContext {
        public TerminalNode WORKDIR() {
            return getToken(DockerParser.WORKDIR, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_workdirInstruction;
        }
    ...
    public static class ArgInstructionContext extends ParserRuleContext {
        public TerminalNode ARG() {
            return getToken(DockerParser.ARG, 0);
        }
        ...
        public TerminalNode EQUALS() {
            return getToken(DockerParser.EQUALS, 0);
        }
    ...
    public static class OnbuildInstructionContext extends ParserRuleContext {
        public TerminalNode ONBUILD() {
            return getToken(DockerParser.ONBUILD, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_onbuildInstruction;
        }
    ...
    public static class StopsignalInstructionContext extends ParserRuleContext {
        public TerminalNode STOPSIGNAL() {
            return getToken(DockerParser.STOPSIGNAL, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_stopsignalInstruction;
        }
    ...
    public static class HealthcheckInstructionContext extends ParserRuleContext {
        public TerminalNode HEALTHCHECK() {
            return getToken(DockerParser.HEALTHCHECK, 0);
        }

        public TerminalNode NONE() {
            return getToken(DockerParser.NONE, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_healthcheckInstruction;
        }
    ...
    public static class HealthcheckOptionsContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_healthcheckOptions;
        }
    ...
    public static class HealthcheckOptionContext extends ParserRuleContext {
        public TerminalNode FLAG() {
            return getToken(DockerParser.FLAG, 0);
        }
    ...
    public static class ShellInstructionContext extends ParserRuleContext {
        public TerminalNode SHELL() {
            return getToken(DockerParser.SHELL, 0);
        }
    ...
    public static class MaintainerInstructionContext extends ParserRuleContext {
        public TerminalNode MAINTAINER() {
            return getToken(DockerParser.MAINTAINER, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_maintainerInstruction;
        }
    ...
    public static class ShellFormTextElementContext extends ParserRuleContext {
        public TerminalNode UNQUOTED_TEXT() {
            return getToken(DockerParser.UNQUOTED_TEXT, 0);
        }

        public TerminalNode DOUBLE_QUOTED_STRING() {
            return getToken(DockerParser.DOUBLE_QUOTED_STRING, 0);
        }

        public TerminalNode SINGLE_QUOTED_STRING() {
            return getToken(DockerParser.SINGLE_QUOTED_STRING, 0);
        }

        public TerminalNode ENV_VAR() {
            return getToken(DockerParser.ENV_VAR, 0);
        }

        public TerminalNode COMMAND_SUBST() {
            return getToken(DockerParser.COMMAND_SUBST, 0);
        }

        public TerminalNode BACKTICK_SUBST() {
            return getToken(DockerParser.BACKTICK_SUBST, 0);
        }

        public TerminalNode SPECIAL_VAR() {
            return getToken(DockerParser.SPECIAL_VAR, 0);
        }
        ...
        public TerminalNode DASH_DASH() {
            return getToken(DockerParser.DASH_DASH, 0);
        }

        public TerminalNode LBRACKET() {
            return getToken(DockerParser.LBRACKET, 0);
        }

        public TerminalNode RBRACKET() {
            return getToken(DockerParser.RBRACKET, 0);
        }

        public TerminalNode COMMA() {
            return getToken(DockerParser.COMMA, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_shellFormTextElement;
        }
    ...
    public static class HeredocContext extends ParserRuleContext {
        ...
        public TerminalNode NEWLINE() {
            return getToken(DockerParser.NEWLINE, 0);
        }
    ...
    public static class HeredocPreambleContext extends ParserRuleContext {
        public List<TerminalNode> HEREDOC_START() {
            return getTokens(DockerParser.HEREDOC_START);
        }
    ...
    public static class HeredocContentContext extends ParserRuleContext {
        public List<TerminalNode> NEWLINE() {
            return getTokens(DockerParser.NEWLINE);
        }
        ...
        public List<TerminalNode> HEREDOC_CONTENT() {
            return getTokens(DockerParser.HEREDOC_CONTENT);
        }
    ...
    public static class JsonArrayElementsContext extends ParserRuleContext {
        ...
        public List<TerminalNode> COMMA() {
            return getTokens(DockerParser.COMMA);
        }
    ...
    public static class LabelOldValueElementContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_labelOldValueElement;
        }
    ...
    public static class EnvTextElementEqualsContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_envTextElementEquals;
        }
