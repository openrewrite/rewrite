...
public class DockerParser extends Parser {
	...
	public static final int
		...
		RULE_labelPair = 43, RULE_labelKeyWithKeyword = 44, RULE_labelKey = 45, 
		RULE_labelValue = 46, RULE_labelOldValue = 47, RULE_labelOldValueElement = 48, 
		RULE_portList = 49, RULE_port = 50, RULE_envPairs = 51, RULE_envPair = 52, 
		RULE_envKey = 53, RULE_envSafeKeyword = 54, RULE_envValueEquals = 55, 
		RULE_envValueSpace = 56, RULE_envTextEquals = 57, RULE_envTextElementEquals = 58, 
		RULE_sourceList = 59, RULE_source = 60, RULE_destination = 61, RULE_path = 62, 
		RULE_pathList = 63, RULE_volumePath = 64, RULE_userSpec = 65, RULE_argName = 66, 
		RULE_argValue = 67, RULE_signal = 68, RULE_text = 69, RULE_textElement = 70;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"jsonString", "imageName", "stageName", "labelPairs", "labelPair", "labelKeyWithKeyword", 
			"labelKey", "labelValue", "labelOldValue", "labelOldValueElement", "portList", 
			"port", "envPairs", "envPair", "envKey", "envSafeKeyword", "envValueEquals", 
	...
	public final FlagNameContext flagName() throws RecognitionException {
		...
		try {
			...
			setState(301);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 34361835528L) != 0)) ) {
	...
	public final FlagValueElementContext flagValueElement() throws RecognitionException {
		...
		try {
			...
			setState(308);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 68316823552L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ShellSafeKeywordContext shellSafeKeyword() throws RecognitionException {
		...
		try {
			...
			setState(334);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 2630160L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class LabelPairContext extends ParserRuleContext {
		public LabelKeyWithKeywordContext labelKeyWithKeyword() {
			return getRuleContext(LabelKeyWithKeywordContext.class,0);
		}
		public TerminalNode EQUALS() { return getToken(DockerParser.EQUALS, 0); }
	...
	@SuppressWarnings("CheckReturnValue")
	public static class LabelKeyWithKeywordContext extends ParserRuleContext {
		public TerminalNode UNQUOTED_TEXT() { return getToken(DockerParser.UNQUOTED_TEXT, 0); }
		public TerminalNode DOUBLE_QUOTED_STRING() { return getToken(DockerParser.DOUBLE_QUOTED_STRING, 0); }
		public TerminalNode SINGLE_QUOTED_STRING() { return getToken(DockerParser.SINGLE_QUOTED_STRING, 0); }
		public TerminalNode MAINTAINER() { return getToken(DockerParser.MAINTAINER, 0); }
		...
		public TerminalNode SHELL() { return getToken(DockerParser.SHELL, 0); }
		public TerminalNode AS() { return getToken(DockerParser.AS, 0); }
		public LabelKeyWithKeywordContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_labelKeyWithKeyword; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DockerParserListener ) ((DockerParserListener)listener).enterLabelKeyWithKeyword(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DockerParserListener ) ((DockerParserListener)listener).exitLabelKeyWithKeyword(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DockerParserVisitor ) return ((DockerParserVisitor<? extends T>)visitor).visitLabelKeyWithKeyword(this);
			else return visitor.visitChildren(this);
		}
	}

	public final LabelKeyWithKeywordContext labelKeyWithKeyword() throws RecognitionException {
		LabelKeyWithKeywordContext _localctx = new LabelKeyWithKeywordContext(_ctx, getState());
		enterRule(_localctx, 88, RULE_labelKeyWithKeyword);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(386);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 35974545400L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final LabelKeyContext labelKey() throws RecognitionException {
		...
		try {
			...
			setState(388);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 35971399680L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final LabelOldValueElementContext labelOldValueElement() throws RecognitionException {
		...
		try {
			...
			setState(397);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 68706893816L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final EnvSafeKeywordContext envSafeKeyword() throws RecognitionException {
		...
		enterRule(_localctx, 108, RULE_envSafeKeyword);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PathListContext pathList() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 68182605824L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"\u0001+\u0001+\u0001+\u0001+\u0001+\u0001+\u0001+\u0003+\u0181\b+\u0001"+
		",\u0001,\u0001-\u0001-\u0001.\u0001.\u0001/\u0004/\u018a\b/\u000b/\f/"+
		"\u018b\u00010\u00010\u00011\u00041\u0191\b1\u000b1\f1\u0192\u00012\u0001"+
		"2\u00013\u00043\u0198\b3\u000b3\f3\u0199\u00014\u00014\u00014\u00014\u0001"+
		"4\u00014\u00014\u00034\u01a3\b4\u00015\u00015\u00035\u01a7\b5\u00016\u0001"+
		"6\u00017\u00017\u00018\u00018\u00019\u00049\u01b0\b9\u000b9\f9\u01b1\u0001"+
		":\u0001:\u0001;\u0004;\u01b7\b;\u000b;\f;\u01b8\u0001<\u0001<\u0001=\u0001"+
		"=\u0001>\u0001>\u0001?\u0004?\u01c2\b?\u000b?\f?\u01c3\u0001@\u0001@\u0001"+
		"A\u0001A\u0001B\u0001B\u0001C\u0001C\u0001D\u0001D\u0001E\u0004E\u01d1"+
		"\bE\u000bE\fE\u01d2\u0001F\u0001F\u0001F\u0000\u0000G\u0000\u0002\u0004"+
		"\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a\u001c\u001e \""+
