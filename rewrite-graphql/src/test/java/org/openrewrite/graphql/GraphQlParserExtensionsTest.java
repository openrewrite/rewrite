...
public class GraphQlParserExtensionsTest implements RewriteTest {
    ...
    @Disabled("Parser issue: Type extension with implements clause")
    @Test
    ...
    @Disabled("Parser issue: Complex field arguments in extensions")
    @Test
    ...
    @Disabled("Parser issue: Directive definition extensions")
    @Test
    ...
    @Disabled("Parser issue: Multiline directive locations")
    @Test
