...
public class GraphQlParserComplexFeaturesTest implements RewriteTest {
    ...
    @Disabled("Parser issue: Complex object default values not fully supported")
    @Test
    ...
    @Disabled("Parser issue: Fragment variable definitions are experimental")
    @Test
    ...
    @Disabled("Parser issue: Complex nested argument structures")
    @Test
    ...
    @Disabled("Parser issue: Complex directive arguments")
    @Test
    ...
    @Disabled("Parser issue: Interface implementation chain with & operator")
    @Test
    ...
    @Disabled("Parser issue: Variable usage in deeply nested structures")
    @Test
