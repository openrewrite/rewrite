...
public class ReloadableJava25ParserInputFileObject implements JavaFileObject {
    ...
    public ReloadableJava25ParserInputFileObject(Parser.Input input, ExecutionContext ctx) {
        this.input = input;
