...
public final class ReloadableJava25ModifierResults {

    private final List<J.Annotation> leadingAnnotations;
    private final List<J.Modifier> modifiers;

    public ReloadableJava25ModifierResults(List<J.Annotation> leadingAnnotations, List<J.Modifier> modifiers) {
