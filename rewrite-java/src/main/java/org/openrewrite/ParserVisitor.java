...
public class ParserVisitor extends TreePathScanner<org.openrewrite.tree.Tree, Formatting> {
    ...
    @Override
    public org.openrewrite.tree.Tree visitAnnotation(AnnotationTree node, Formatting fmt) {
        skip("@");
    ...
    @Override
    public org.openrewrite.tree.Tree visitArrayAccess(ArrayAccessTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitArrayType(ArrayTypeTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitAssert(AssertTree node, Formatting fmt) {
        skip("assert");
        return new J.Assert(J.randomId(), convert(((JCAssert) node).cond), fmt);
    }

    @Override
    public org.openrewrite.tree.Tree visitAssignment(AssignmentTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitBinary(BinaryTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitBlock(BlockTree node, Formatting fmt) {
        J.Empty stat = null;
    ...
    @Override
    public org.openrewrite.tree.Tree visitBreak(BreakTree node, Formatting fmt) {
        skip("break");
    ...
    @Override
    public org.openrewrite.tree.Tree visitCase(CaseTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitCatch(CatchTree node, Formatting fmt) {
        skip("catch");
    ...
    @Override
    public org.openrewrite.tree.Tree visitClass(ClassTree node, Formatting fmt) {
        ...
        var members = Stream.concat(
                Stream.ofNullable((org.openrewrite.tree.Tree) enumSet),
    ...
    @Override
    public org.openrewrite.tree.Tree visitCompilationUnit(CompilationUnitTree node, Formatting fmt) {
...
//        DocCommentTable docTable = cu.docComments;
    ...
    @Override
    public org.openrewrite.tree.Tree visitCompoundAssignment(CompoundAssignmentTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitConditionalExpression(ConditionalExpressionTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitContinue(ContinueTree node, Formatting fmt) {
        skip("continue");
    ...
    @Override
    public org.openrewrite.tree.Tree visitDoWhileLoop(DoWhileLoopTree node, Formatting fmt) {
        skip("do");
    ...
    @Override
    public org.openrewrite.tree.Tree visitEmptyStatement(EmptyStatementTree node, Formatting fmt) {
        return new J.Empty(J.randomId(), fmt);
    }

    @Override
    public org.openrewrite.tree.Tree visitEnhancedForLoop(EnhancedForLoopTree node, Formatting fmt) {
        skip("for");
    ...
    private org.openrewrite.tree.Tree visitEnumVariable(VariableTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitForLoop(ForLoopTree node, Formatting fmt) {
        skip("for");
        var ctrlPrefix = sourceBefore("(");
    ...
    @Override
    public org.openrewrite.tree.Tree visitIdentifier(IdentifierTree node, Formatting fmt) {
        cursor += node.getName().toString().length();
        return J.Ident.build(J.randomId(), node.getName().toString(), type(node), fmt);
    }

    @Override
    public org.openrewrite.tree.Tree visitIf(IfTree node, Formatting fmt) {
        skip("if");
    ...
    @Override
    public org.openrewrite.tree.Tree visitImport(ImportTree node, Formatting fmt) {
        skip("import");
    ...
    @Override
    public org.openrewrite.tree.Tree visitInstanceOf(InstanceOfTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitLabeledStatement(LabeledStatementTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitLambdaExpression(LambdaExpressionTree node, Formatting fmt) {
        ...
        org.openrewrite.tree.Tree body;
    ...
    @Override
    public org.openrewrite.tree.Tree visitLiteral(LiteralTree node, Formatting fmt) {
        cursor(endPos(node));
    ...
    @Override
    public org.openrewrite.tree.Tree visitMemberReference(MemberReferenceTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitMemberSelect(MemberSelectTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitMethodInvocation(MethodInvocationTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitMethod(MethodTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitNewArray(NewArrayTree node, Formatting fmt) {
        skip("new");
    ...
    @Override
    public org.openrewrite.tree.Tree visitNewClass(NewClassTree node, Formatting fmt) {
        skip("new");
    ...
    @Override
    public org.openrewrite.tree.Tree visitParameterizedType(ParameterizedTypeTree node, Formatting fmt) {
        return new J.ParameterizedType(J.randomId(), convert(node.getType()), convertTypeParameters(node.getTypeArguments()), fmt);
    }

    @Override
    public org.openrewrite.tree.Tree visitParenthesized(ParenthesizedTree node, Formatting fmt) {
        skip("(");
        return new J.Parentheses<Expression>(J.randomId(), convert(node.getExpression(), t -> sourceBefore(")")), fmt);
    }

    @Override
    public org.openrewrite.tree.Tree visitPrimitiveType(PrimitiveTypeTree node, Formatting fmt) {
        cursor(endPos(node));
    ...
    @Override
    public org.openrewrite.tree.Tree visitReturn(ReturnTree node, Formatting fmt) {
        skip("return");
        return new J.Return(J.randomId(), convertOrNull(node.getExpression()), fmt);
    }

    @Override
    public org.openrewrite.tree.Tree visitSwitch(SwitchTree node, Formatting fmt) {
        skip("switch");
    ...
    @Override
    public org.openrewrite.tree.Tree visitSynchronized(SynchronizedTree node, Formatting fmt) {
        skip("synchronized");
    ...
    @Override
    public org.openrewrite.tree.Tree visitThrow(ThrowTree node, Formatting fmt) {
        skip("throw");
        return new J.Throw(J.randomId(), convert(node.getExpression()), fmt);
    }

    @Override
    public org.openrewrite.tree.Tree visitTry(TryTree node, Formatting fmt) {
        skip("try");
    ...
    @Override
    public org.openrewrite.tree.Tree visitTypeCast(TypeCastTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitTypeParameter(TypeParameterTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitUnionType(UnionTypeTree node, Formatting fmt) {
        return new J.MultiCatch(J.randomId(), convertAll(node.getTypeAlternatives(), t -> sourceBefore("|"), noDelim), fmt);
    }

    @Override
    public org.openrewrite.tree.Tree visitUnary(UnaryTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitVariable(VariableTree node, Formatting fmt) {
    ...
    @Override
    public org.openrewrite.tree.Tree visitWhileLoop(WhileLoopTree node, Formatting fmt) {
        skip("while");
    ...
    @Override
    public org.openrewrite.tree.Tree visitWildcard(WildcardTree node, Formatting fmt) {
        skip("?");
    ...
    private <T extends org.openrewrite.tree.Tree> T convert(com.sun.source.tree.Tree t) {
        return convert(t, t2 -> "");
    }

    private <T extends org.openrewrite.tree.Tree> T convert(com.sun.source.tree.Tree t2, Function<com.sun.source.tree.Tree, String> suffix) {
        try {
    ...
    private <T extends org.openrewrite.tree.Tree> T convertOrNull(@Nullable com.sun.source.tree.Tree t) {
        return convertOrNull(t, t2 -> "");
    }

    @Nullable
    private <T extends org.openrewrite.tree.Tree> T convertOrNull(@Nullable com.sun.source.tree.Tree t, Function<com.sun.source.tree.Tree, String> suffix) {
        return t == null ? null : convert(t, suffix);
    }

    private <T extends org.openrewrite.tree.Tree> List<T> convertAll(List<? extends Tree> trees, Function<Tree, String> innerSuffix, Function<Tree, String> suffix) {
    ...
    private <T extends org.openrewrite.tree.Tree> List<T> convertPossibleMultiVariable(@Nullable List<? extends Tree> trees) {
        if (trees == null)
            return emptyList();
