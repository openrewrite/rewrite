...
public class Space implements Markable {
    ...
    public enum Location {
        ...
        METHOD_DECL_PARAMETERS,
        METHOD_DECL_PARAMETER_SUFFIX,
        METHOD_DECL_DEFAULT_VALUE,
        METHOD_DECL_PREFIX,
        ...
        NEW_ARRAY_PREFIX,
        NEW_CLASS_ARGS,
        NEW_CLASS_ARGS_SUFFIX,
        NEW_CLASS_ENCL_SUFFIX,
        NEW_CLASS_PREFIX,
        NEW_PREFIX,
        PACKAGE_PREFIX,
        PACKAGE_SUFFIX,
        ...
        WILDCARD_BOUND,
        WILDCARD_PREFIX,
        REPLACE, //Used ONLY to indicate replace semanatics in Java Template
    }
}
