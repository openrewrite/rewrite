...
public class Spaces extends Recipe {
    ...
    public Spaces() {
        this.processor = SpacesProcessor::new;
    }

    private static class SpacesProcessor extends JavaIsoProcessor<ExecutionContext> {

        /*
        TODO Finish support for SpacesStyle properties, from SpacesStyle.Within.groupingParentheses down
         */

        private SpacesStyle style;

        private SpacesProcessor() {
            setCursoringOn();
        }
        ...
        public J.CompilationUnit visitCompilationUnit(J.CompilationUnit cu, ExecutionContext executionContext) {
            style = cu.getStyle(SpacesStyle.class);
            if (style == null) {
        ...
        @Override
        public J.ClassDecl visitClassDecl(J.ClassDecl classDecl, ExecutionContext executionContext) {
            J.ClassDecl classDecl1 = super.visitClassDecl(classDecl, executionContext);
        ...
        public J.MethodDecl visitMethod(J.MethodDecl method, ExecutionContext executionContext) {
            J.MethodDecl methodDecl = super.visitMethod(method, executionContext);
        ...
        public J.If visitIf(J.If iff, ExecutionContext executionContext) {
            J.If anIf = super.visitIf(iff, executionContext);
        ...
        @Override
        public J.If.Else visitElse(J.If.Else elze, ExecutionContext executionContext) {
            J.If.Else anElse = super.visitElse(elze, executionContext);
        ...
        @Override
        public J.ForEachLoop visitForEachLoop(J.ForEachLoop forLoop, ExecutionContext executionContext) {
            J.ForEachLoop forEachLoop = super.visitForEachLoop(forLoop, executionContext);
        ...
        public J.WhileLoop visitWhileLoop(J.WhileLoop whileLoop, ExecutionContext executionContext) {
            J.WhileLoop wl = super.visitWhileLoop(whileLoop, executionContext);
        ...
        public J.DoWhileLoop visitDoWhileLoop(J.DoWhileLoop doWhileLoop, ExecutionContext executionContext) {
            J.DoWhileLoop dwl = super.visitDoWhileLoop(doWhileLoop, executionContext);
        ...
        @Override
        public J.Switch visitSwitch(J.Switch _switch, ExecutionContext executionContext) {
            J.Switch aSwitch = super.visitSwitch(_switch, executionContext);
        ...
        public J.Try visitTry(J.Try _try, ExecutionContext executionContext) {
            J.Try aTry = super.visitTry(_try, executionContext);
        ...
        public J.Try.Catch visitCatch(J.Try.Catch _catch, ExecutionContext executionContext) {
            J.Try.Catch aCatch = super.visitCatch(_catch, executionContext);
        ...
        @Override
        public J.Synchronized visitSynchronized(J.Synchronized _sync, ExecutionContext executionContext) {
            J.Synchronized aSynchronized = super.visitSynchronized(_sync, executionContext);
        ...
        @Override
        public J.Assign visitAssign(J.Assign assign, ExecutionContext executionContext) {
            J.Assign assign1 = super.visitAssign(assign, executionContext);
        ...
        @Override
        public J.AssignOp visitAssignOp(J.AssignOp assignOp, ExecutionContext executionContext) {
            J.AssignOp assignOp1 = super.visitAssignOp(assignOp, executionContext);
        ...
        public J.Binary visitBinary(J.Binary binary, ExecutionContext executionContext) {
            J.Binary binary1 = super.visitBinary(binary, executionContext);
        ...
        public J.Unary visitUnary(J.Unary unary, ExecutionContext executionContext) {
            J.Unary unary1 = super.visitUnary(unary, executionContext);
        ...
        public J.NewArray visitNewArray(J.NewArray newArray, ExecutionContext executionContext) {
            J.NewArray newArray1 = super.visitNewArray(newArray, executionContext);
        ...
        public J.ArrayAccess visitArrayAccess(J.ArrayAccess arrayAccess, ExecutionContext executionContext) {
            J.ArrayAccess arrayAccess1 = super.visitArrayAccess(arrayAccess, executionContext);
