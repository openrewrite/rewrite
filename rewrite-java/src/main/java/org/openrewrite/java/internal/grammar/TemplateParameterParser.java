...
public class TemplateParameterParser extends Parser {
    ...
    public static class TypedPatternContext extends ParserRuleContext {
        ...
        public TerminalNode COLON() {
            return getToken(TemplateParameterParser.COLON, 0);
        }
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public TerminalNode LBRACK() {
            return getToken(TemplateParameterParser.LBRACK, 0);
        }
        ...
        public TerminalNode RBRACK() {
            return getToken(TemplateParameterParser.RBRACK, 0);
        }

        public List<TerminalNode> COMMA() {
            return getTokens(TemplateParameterParser.COMMA);
        }
    ...
    public static class TypeParameterContext extends ParserRuleContext {
        ...
        public TerminalNode WILDCARD() {
            return getToken(TemplateParameterParser.WILDCARD, 0);
        }
    ...
    public static class VarianceContext extends ParserRuleContext {
        ...
        public TerminalNode Variance() {
            return getToken(TemplateParameterParser.Variance, 0);
        }
