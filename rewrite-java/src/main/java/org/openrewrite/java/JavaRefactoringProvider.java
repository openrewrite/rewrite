 ...
 *
 * Methods marked with @RefactoringProvider should be public static and return a
 *  <pre>List{@literal <}RefactorVisitor></pre>.
 */
@Documented
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
public @interface JavaRefactoringProvider {
}
