...
public class MigrateJavaTemplateToRewrite8 extends Recipe {
    ...
    private static final String GET_CURSOR_COMMENT = "[Rewrite8 migration] getCursor() could be updateCursor() if the J instance is updated in this visit method, please follow the migration guide";
