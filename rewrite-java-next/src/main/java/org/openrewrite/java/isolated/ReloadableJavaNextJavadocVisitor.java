...
public class ReloadableJavaNextJavadocVisitor extends DocTreeScanner<Tree, List<Javadoc>> {
    ...
    public ReloadableJavaNextJavadocVisitor(Context context, TreePath scope, ReloadableJavaNextTypeMapping typeMapping, String source, JCTree tree) {
        this(context, scope, typeMapping, source, tree, false);
    }

    public ReloadableJavaNextJavadocVisitor(Context context, TreePath scope, ReloadableJavaNextTypeMapping typeMapping, String source, JCTree tree, boolean markdown) {
