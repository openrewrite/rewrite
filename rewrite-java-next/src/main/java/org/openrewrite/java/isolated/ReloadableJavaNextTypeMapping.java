...
class ReloadableJavaNextTypeMapping implements JavaTypeMapping<Tree> {

    private final ReloadableJavaNextTypeSignatureBuilder signatureBuilder = new ReloadableJavaNextTypeSignatureBuilder();
