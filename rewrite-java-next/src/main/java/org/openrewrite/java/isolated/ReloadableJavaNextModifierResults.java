...
public final class ReloadableJavaNextModifierResults {

    private final List<J.Annotation> leadingAnnotations;
    private final List<J.Modifier> modifiers;

    public ReloadableJavaNextModifierResults(List<J.Annotation> leadingAnnotations, List<J.Modifier> modifiers) {
