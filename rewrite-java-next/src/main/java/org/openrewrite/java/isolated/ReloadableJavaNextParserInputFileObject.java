...
public class ReloadableJavaNextParserInputFileObject implements JavaFileObject {
    ...
    public ReloadableJavaNextParserInputFileObject(Parser.Input input, ExecutionContext ctx) {
        this.input = input;
