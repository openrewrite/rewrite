...
/**
 * Carries a structured {@link Failure} out of the engine's deep call stack; the
 * engine entry point converts it to a failed {@code Result}, never a thrown error.
 */
@Getter
class EngineFailure extends RuntimeException {
