 ...
 * MOVE to a new version. Each byte-exact test replays a fixture entirely OFFLINE (a stub {@code HttpSender}
 ...
 */
class NpmCascadeLockRegenTest extends LockRegenTestSupport {
