...
describe("getLockFileFormat", () => {
    ...
    test("the format follows from the file name", () => {
        ...
        // yarn.lock spans both formats, so the name alone cannot decide
        expect(getLockFileFormat("yarn.lock")).toBe("text");
    });

    test("yarn.lock content decides between the Classic and Berry formats", () => {
        expect(getLockFileFormat("yarn.lock", `
# THIS IS AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.
# yarn lockfile v1
