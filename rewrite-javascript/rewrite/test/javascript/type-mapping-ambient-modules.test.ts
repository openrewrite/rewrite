...
describe("AMD module bindings", () => {
    // AMD binds dependency to parameter positionally at loader runtime, so the parser declares it.
    test("a factory parameter carries the type of the dependency bound to it", async () => {
        ...
        // The namespace resolves on its own, which keeps the rest of the test to the parameter.
