...
/**
 * Synchronous version of mapAsync. Maps over an array, preserving identity if no changes.
 * Returns the original array if nothing changed, or a new array with updates applied.
 * Filters out undefined results.
 */
export function mapSync<T, U>(arr: T[], fn: (t: T, i: number) => U | undefined): U[] {
    let results: U[] | undefined = undefined;
