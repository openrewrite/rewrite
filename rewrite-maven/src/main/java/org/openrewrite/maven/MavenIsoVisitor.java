...
public class MavenIsoVisitor<P> extends MavenVisitor<P> {
    ...
    @Override
    public Xml.ProcessingInstruction visitProcessingInstruction(Xml.ProcessingInstruction pi, P p) {
        return (Xml.ProcessingInstruction) super.visitProcessingInstruction(pi, p);
    }
