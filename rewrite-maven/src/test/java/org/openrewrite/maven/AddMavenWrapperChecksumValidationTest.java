...
class AddMavenWrapperChecksumValidationTest implements RewriteTest {
    ...
    public void defaults(RecipeSpec spec) {
        spec.recipe(new AddMavenWrapperChecksumValidation("3.9.1", "3.2.0"));
    }
    ...
    void addDistributionSha256Sum() {
        rewriteRun(
          properties(
            ...
            spec -> spec.path(MAVEN_WRAPPER_PROPERTIES)
          )
        );
    }
