...
class ChangePluginConfigurationTest : MavenRecipeTest {

    @Test
    fun removeConfiguration() = assertChanged(
        recipe = ChangePluginConfiguration("org.openrewrite.maven", "rewrite-maven-plugin", null),
        before = """
            <project>
    ...
    fun addConfiguration() = assertChanged(
        recipe = ChangePluginConfiguration(
