...
class RemoveAnnotationTest implements RewriteTest {
    ...
    @Test
    void packageNestedAnnotation() {
        rewriteRun(
          spec -> spec.recipe(new RemoveAnnotation("@foo..Qux")),
          java(
            """
              package foo.bar.baz;
    ...
    @Test
    void unqualifiedJavaLangAnnotation() {
        rewriteRun(
          spec -> spec.recipe(new RemoveAnnotation("@Deprecated")),
          java(
            """
              @Deprecated
              public class RemoveAnnotation {
