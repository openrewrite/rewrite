...
//        SourceSpec<Toml.Document> doc = new SourceSpec<>(Toml.Document.class, null, TomlParser.builder(), before, null);
//        spec.accept(xml);
//        return xml;
//    }
//
...
//        SourceSpec<Toml.Document> doc = new SourceSpec<>(Toml.Document.class, null, TomlParser.builder(), before, s -> after);
//        spec.accept(doc);
//        return doc;
//    }
}
