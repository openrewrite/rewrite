...
public class WriteModel extends Recipe {
    ...
    JavaVisitor<ExecutionContext> writeModelClass = new JavaIsoVisitor<ExecutionContext>() {
        ...
        final JavaTemplate implementsTree = JavaTemplate.builder("Ruby").javaParser(parser).build();
        ...
        final JavaTemplate acceptMethod = JavaTemplate.builder(
                """
                        @Override public <P> Ruby acceptRuby(RubyVisitor<P> v, P p) {
        ...
        final JavaTemplate unwrappedPaddedGetterWither = JavaTemplate.builder(
                """
                        ...
                        public #{} with#{}(#{} #{}) {
                            ...
                            return getPadding().with#{}(Ruby#{}Padded.withElement(this.#{}, #{}));
                        }
                        """
        ).javaParser(parser).build();
        ...
        final JavaTemplate unwrappedContainerGetterWither = JavaTemplate.builder(
                """
                        ...
                        public #{} with#{}(List<#{}> #{}) {
                            return getPadding().with#{}(this.#{}.getPadding().withElements(JRightPadded.withElements(
                    ...
                    if (fqn != null) {
                        if (elementType != null) {
                            c = switch (fqn.getClassName()) {
                                case "JContainer" -> writeContainerGetterWithers(c, varDec, elementType);
                                case "JLeftPadded" -> writePaddedGetterWithers(c, varDec, elementType, "Left");
                                case "JRightPadded" -> writePaddedGetterWithers(c, varDec, elementType, "Right");
