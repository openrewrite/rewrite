...
interface JavaTypeSerializerTest {
    ...
    fun serializeWildcard(jp: JavaParser) {
        ...
        var typeParameter = (variableType as JavaType.Parameterized).typeParameters[0] as JavaType.Wildcard
        ...
        assertThat(typeParameter.boundKind).isEqualTo(JavaType.Wildcard.BoundKind.Extends)
        ...
        typeParameter = (variableType as JavaType.Parameterized).typeParameters[0] as JavaType.Wildcard
        assertThat(TypeUtils.deepEquals(variableType, copy)).isTrue()
        assertThat(typeParameter.fullyQualifiedName).isEqualTo("java.lang.Number")
        assertThat(typeParameter.boundKind).isEqualTo(JavaType.Wildcard.BoundKind.Super)
        ...
        assertThat(typeParameter.boundKind).isEqualTo(JavaType.Wildcard.BoundKind.Unbound)
