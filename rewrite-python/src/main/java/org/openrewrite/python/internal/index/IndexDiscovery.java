 ...
 * Source URL credentials whose {@code ${VAR}} placeholders cannot be resolved are dropped (and
 * recorded on the index), so host-supplied credentials, {@code .netrc}, or none apply instead.
 */
