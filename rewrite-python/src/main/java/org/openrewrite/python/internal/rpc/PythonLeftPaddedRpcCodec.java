...
public class PythonLeftPaddedRpcCodec extends DynamicDispatchRpcCodec<JLeftPadded> {
    ...
    public void rpcSend(JLeftPadded after, RpcSendQueue q) {
        ...
        new PythonSender().visitLeftPadded(after, q);
    }

    @Override
    public JLeftPadded rpcReceive(JLeftPadded before, RpcReceiveQueue q) {
        //noinspection unchecked
        return new PythonReceiver().visitLeftPadded(before, q);
    }
}
