...
public class PythonRightPaddedRpcCodec extends DynamicDispatchRpcCodec<JRightPadded> {
    ...
    public void rpcSend(JRightPadded after, RpcSendQueue q) {
        ...
        new PythonSender().visitRightPadded(after, q);
    }

    @Override
    public JRightPadded rpcReceive(JRightPadded before, RpcReceiveQueue q) {
        //noinspection unchecked
        return new PythonReceiver().visitRightPadded(before, q);
    }
}
