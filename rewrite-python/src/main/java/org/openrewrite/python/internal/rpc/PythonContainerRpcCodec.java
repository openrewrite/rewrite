...
public class PythonContainerRpcCodec extends DynamicDispatchRpcCodec<JContainer> {
    ...
    public void rpcSend(JContainer after, RpcSendQueue q) {
        ...
        new PythonSender().visitContainer(after, q);
    }

    @Override
    public JContainer rpcReceive(JContainer before, RpcReceiveQueue q) {
        //noinspection unchecked
        return new PythonReceiver().visitContainer(before, q);
    }
}
