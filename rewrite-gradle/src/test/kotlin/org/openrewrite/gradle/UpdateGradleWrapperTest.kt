...
class UpdateGradleWrapperTest {
    ...
    private val gradlew = PlainText(Tree.randomId(), Paths.get("gradlew"), Markers.EMPTY, "")
    private val gradlewBat = PlainText(Tree.randomId(), Paths.get("gradlew.bat"), Markers.EMPTY, "")
