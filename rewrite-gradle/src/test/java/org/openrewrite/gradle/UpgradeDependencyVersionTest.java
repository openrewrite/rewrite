...
class UpgradeDependencyVersionTest implements RewriteTest {
    ...
    @Test
    void shellCommandsWithEscapesTripleDoubleQuotes() {
        rewriteRun(
          buildGradle(
            """
              plugins {
    ...
    @Test
    void shellCommandsWithEscapesTripleSingleQuotes() {
        rewriteRun(
          buildGradle(
            """
              plugins {
    ...
    @Test
    void shellCommandsWithEscapesDoubleQuotes() {
        rewriteRun(
          buildGradle(
            """
              plugins {
    ...
    @Test
    void shellCommandsWithEscapesSingleQuotes() {
        rewriteRun(
          buildGradle(
            """
              plugins {
