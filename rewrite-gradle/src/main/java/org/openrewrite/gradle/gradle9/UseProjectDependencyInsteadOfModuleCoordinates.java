...
public class UseProjectDependencyInsteadOfModuleCoordinates extends Recipe {
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        // GroovyIsoVisitor only accepts G.CompilationUnit; the `project('...')` replacement is generated by the
        // Groovy GradleParser, so restrict to the Groovy DSL rather than emitting Groovy notation into Kotlin scripts.
