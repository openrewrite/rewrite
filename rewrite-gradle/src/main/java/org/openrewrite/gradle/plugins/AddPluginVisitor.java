...
public class AddPluginVisitor extends GroovyIsoVisitor<ExecutionContext> {
    ...
    public G.CompilationUnit visitCompilationUnit(G.CompilationUnit cu, ExecutionContext ctx) {
        ...
        if (newVersion == null) {
            ...
            try {
                version = new DependencyVersionSelector(null, null, maybeGp.orElse(null), maybeGs.orElse(null)).select(new GroupArtifact(pluginId, pluginId + ".gradle.plugin"), "classpath", newVersion, versionPattern, ctx);
