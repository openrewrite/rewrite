...
public class CsLeftPadded {
    public enum Location {
        ...
        WHEN_CLAUSE_INITIALIZER(CsSpace.Location.TRY_CATCH_FILTER_EXPRESSION),
        ...
        CONSTRAINED_TYPE_PARAMETER_VARIANCE(CsSpace.Location.CONSTRAINED_TYPE_PARAMETER_VARIANCE),
        CONSTRAINED_TYPE_PARAMETER_WHERE_CONSTRAINT(CsSpace.Location.CONSTRAINED_TYPE_PARAMETER_WHERE_CONSTRAINT),
        WITH_EXPRESSION_INITIALIZER(CsSpace.Location.WITH_EXPRESSION_INITIALIZER),
        FUNCTION_POINTER_TYPE_CALLING_CONVENTION(CsSpace.Location.FUNCTION_POINTER_TYPE_CALLING_CONVENTION);
