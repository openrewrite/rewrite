...
public class CsSpace {
    public enum Location {
        ...
        TRY_CATCH_FILTER_EXPRESSION, TRY_FINALLIE, POINTER_TYPE_ELEMENT_TYPE, CHECKED_EXPRESSION_PREFIX, REF_EXPRESSION_PREFIX, REF_TYPE_PREFIX, POINTER_FIELD_ACCESS_PREFIX, POINTER_FIELD_ACCESS_NAME, ACCESSOR_DECLARATION_KIND, GOTO_STATEMENT_PREFIX, EVENT_DECLARATION_PREFIX, EVENT_DECLARATION_TYPE_EXPRESSION, EVENT_DECLARATION_INTERFACE_SPECIFIER, EVENT_DECLARATION_ACCESSORS, TRY_CATCH_PREFIX, TRY_PREFIX, STACK_ALLOC_EXPRESSION_PREFIX, ANY, OPERATOR_DECLARATION_OPERATOR_TOKEN, OPERATOR_DECLARATION_PARAMETERS, OPERATOR_DECLARATION_EXPLICIT_INTERFACE_SPECIFIER, INDEXER_DECLARATION_EXPLICIT_INTERFACE_SPECIFIER, OPERATOR_DECLARATION_PREFIX, NAME_COLON_PREFIX, NAME_COLON_NAME,
        CONDITIONAL_BLOCK_PREFIX,
        CONDITIONAL_BLOCK_BEFORE_ENDIF,
        IF_DIRECTIVE_PREFIX,
        IF_DIRECTIVE_BODY_SUFFIX,
        ELIF_DIRECTIVE_PREFIX,
        ELIF_DIRECTIVE_BODY_SUFFIX,
        ELSE_DIRECTIVE_PREFIX,
        ELSE_DIRECTIVE_BODY_SUFFIX,
