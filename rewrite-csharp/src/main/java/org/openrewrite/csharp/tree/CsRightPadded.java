...
public interface CsRightPadded {
    enum Location {
        ...
        NAMESPACE_DECLARATION_EXTERNS(CsSpace.Location.NAMESPACE_DECLARATION_EXTERNS_SUFFIX),
        NAMESPACE_DECLARATION_MEMBERS(CsSpace.Location.NAMESPACE_DECLARATION_MEMBERS_SUFFIX),
        NAMESPACE_DECLARATION_NAME(CsSpace.Location.NAMESPACE_DECLARATION_NAME_SUFFIX),
        NAMESPACE_DECLARATION_USINGS(CsSpace.Location.NAMESPACE_DECLARATION_USINGS_SUFFIX),
        ...
        USING_STATEMENT_RESOURCE(CsSpace.Location.USING_STATEMENT_RESOURCES),
        ...
        INDEXER_DECLARATION_EXPLICIT_INTERFACE_SPECIFIER(CsSpace.Location.INDEXER_DECLARATION_EXPLICIT_INTERFACE_SPECIFIER), NAME_COLON_NAME(CsSpace.Location.NAME_COLON_NAME), NAMED_EXPRESSION_NAME(CsSpace.Location.NAMED_EXPRESSION_NAME),
        CONDITIONAL_DIRECTIVE_BRANCHES(CsSpace.Location.CONDITIONAL_DIRECTIVE_BRANCHES_SUFFIX),
        PRAGMA_WARNING_DIRECTIVE_WARNING_CODES(CsSpace.Location.PRAGMA_WARNING_DIRECTIVE_WARNING_CODES_SUFFIX),
        CONSTRAINED_TYPE_PARAMETER_CONSTRAINTS(CsSpace.Location.CONSTRAINED_TYPE_PARAMETER_CONSTRAINTS),
        ANONYMOUS_OBJECT_CREATION_EXPRESSION_INITIALIZERS(CsSpace.Location.ANONYMOUS_OBJECT_CREATION_EXPRESSION_INITIALIZERS),
        FUNCTION_POINTER_TYPE_UNMANAGED_CALLING_CONVENTION_TYPES(CsSpace.Location.FUNCTION_POINTER_TYPE_UNMANAGED_CALLING_CONVENTION_TYPES),
        FUNCTION_POINTER_TYPE_PARAMETER_TYPES(CsSpace.Location.FUNCTION_POINTER_TYPE_PARAMETER_TYPES),
        TYPE_WITH_ARGUMENTS_ARGUMENTS(CsSpace.Location.TYPE_WITH_ARGUMENTS_ARGUMENTS_SUFFIX),
        EXPLICIT_INTERFACE_MEMBER_INTERFACE_SPECIFIER(CsSpace.Location.EXPLICIT_INTERFACE_MEMBER_INTERFACE_SPECIFIER),
        CONVERSION_OPERATOR_DECLARATION_INTERFACE_SPECIFIER(CsSpace.Location.CONVERSION_OPERATOR_DECLARATION_INTERFACE_SPECIFIER);
