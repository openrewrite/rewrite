...
class CSharpRpcTest {
    ...
    @Test
    void parseUsingVarDeclaration(@TempDir Path tempDir) throws IOException {
        String source = """
                using System;
        ...
        Path sourceFile = tempDir.resolve("CryptoHelper.cs");
        Files.writeString(sourceFile, source);
    ...
    @Test
    void parseAwaitUsingVarDeclaration(@TempDir Path tempDir) throws IOException {
        String source = """
                using System;
                using System.IO;
                using System.Threading.Tasks;
        ...
        Path sourceFile = tempDir.resolve("AsyncHelper.cs");
        Files.writeString(sourceFile, source);
    ...
    @Test
    void parseUsingBlockAndUsingVarInSameMethod(@TempDir Path tempDir) throws IOException {
        String source = """
                using System;
                using System.IO;
                namespace App
                {
                    public class MixedUsing
                    {
                        public void M()
                        {
        ...
        Path sourceFile = tempDir.resolve("MixedUsing.cs");
        Files.writeString(sourceFile, source);
