...
public class NetFrameworkAttestationTests : IDisposable
{
    ...
    /// <summary>
    /// The restore graph is generated by a child <c>dotnet msbuild</c>, so a list-valued global
    /// property has to survive the command line: an unescaped <c>;</c> ends the <c>-p:</c>
    /// switch and MSBuild rejects the rest as an unknown switch, losing the graph and with it
