...
/**
 * A resolver {@link org.eclipse.aether.spi.connector.transport.Transporter} that pumps every byte through an
 * injected OpenRewrite {@link HttpSender}. All retry/checksum/resume/caching logic lives above this in
 * BasicRepositoryConnector; this is a dumb byte pump plus the load-bearing {@link #classify(Throwable)}.
 */
class HttpSenderTransporter extends AbstractTransporter {
    ...
    /** Maps to {@link org.eclipse.aether.spi.connector.transport.Transporter#ERROR_NOT_FOUND} via {@link #classify}. */
    ...
    /** Any other transfer error; classifies as ERROR_OTHER. */
