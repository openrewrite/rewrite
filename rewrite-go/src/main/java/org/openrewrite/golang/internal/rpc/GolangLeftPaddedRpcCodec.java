...
public class GolangLeftPaddedRpcCodec extends DynamicDispatchRpcCodec<JLeftPadded> {
    ...
    public void rpcSend(JLeftPadded after, RpcSendQueue q) {
        ...
        new GolangSender().visitLeftPadded(after, q);
    }

    @Override
    public JLeftPadded rpcReceive(JLeftPadded before, RpcReceiveQueue q) {
        //noinspection unchecked
        return new GolangReceiver().visitLeftPadded(before, q);
    }
}
