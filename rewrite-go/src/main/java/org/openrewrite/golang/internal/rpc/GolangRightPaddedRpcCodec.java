...
public class GolangRightPaddedRpcCodec extends DynamicDispatchRpcCodec<JRightPadded> {
    ...
    public void rpcSend(JRightPadded after, RpcSendQueue q) {
        ...
        new GolangSender().visitRightPadded(after, q);
    }

    @Override
    public JRightPadded rpcReceive(JRightPadded before, RpcReceiveQueue q) {
        //noinspection unchecked
        return new GolangReceiver().visitRightPadded(before, q);
    }
}
