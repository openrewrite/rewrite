...
public class GolangContainerRpcCodec extends DynamicDispatchRpcCodec<JContainer> {
    ...
    public void rpcSend(JContainer after, RpcSendQueue q) {
        ...
        new GolangSender().visitContainer(after, q);
    }

    @Override
    public JContainer rpcReceive(JContainer before, RpcReceiveQueue q) {
        //noinspection unchecked
        return new GolangReceiver().visitContainer(before, q);
    }
}
