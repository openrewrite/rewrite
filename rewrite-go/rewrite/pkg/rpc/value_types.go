...
func init() {
	...
	RegisterValueType(reflect.TypeOf((*tree.CompilationUnit)(nil)), "org.openrewrite.golang.tree.G$CompilationUnit")
	RegisterValueType(reflect.TypeOf((*tree.GoStmt)(nil)), "org.openrewrite.golang.tree.G$GoStatement")
	RegisterValueType(reflect.TypeOf((*tree.Defer)(nil)), "org.openrewrite.golang.tree.G$Defer")
	RegisterValueType(reflect.TypeOf((*tree.Send)(nil)), "org.openrewrite.golang.tree.G$Send")
	RegisterValueType(reflect.TypeOf((*tree.Goto)(nil)), "org.openrewrite.golang.tree.G$Goto")
	RegisterValueType(reflect.TypeOf((*tree.Fallthrough)(nil)), "org.openrewrite.golang.tree.G$Fallthrough")
	RegisterValueType(reflect.TypeOf((*tree.Composite)(nil)), "org.openrewrite.golang.tree.G$Composite")
	RegisterValueType(reflect.TypeOf((*tree.KeyValue)(nil)), "org.openrewrite.golang.tree.G$KeyValue")
	RegisterValueType(reflect.TypeOf((*tree.Slice)(nil)), "org.openrewrite.golang.tree.G$SliceExpr")
	RegisterValueType(reflect.TypeOf((*tree.MapType)(nil)), "org.openrewrite.golang.tree.G$MapType")
	RegisterValueType(reflect.TypeOf((*tree.Channel)(nil)), "org.openrewrite.golang.tree.G$Channel")
	RegisterValueType(reflect.TypeOf((*tree.FuncType)(nil)), "org.openrewrite.golang.tree.G$FuncType")
	RegisterValueType(reflect.TypeOf((*tree.StructType)(nil)), "org.openrewrite.golang.tree.G$StructType")
	RegisterValueType(reflect.TypeOf((*tree.InterfaceType)(nil)), "org.openrewrite.golang.tree.G$InterfaceType")
	RegisterValueType(reflect.TypeOf((*tree.TypeList)(nil)), "org.openrewrite.golang.tree.G$TypeList")
	RegisterValueType(reflect.TypeOf((*tree.TypeDecl)(nil)), "org.openrewrite.golang.tree.G$TypeDecl")
	RegisterValueType(reflect.TypeOf((*tree.MultiAssignment)(nil)), "org.openrewrite.golang.tree.G$MultiAssignment")
	RegisterValueType(reflect.TypeOf((*tree.CommClause)(nil)), "org.openrewrite.golang.tree.G$CommClause")
	RegisterValueType(reflect.TypeOf((*tree.IndexList)(nil)), "org.openrewrite.golang.tree.G$IndexList")
	...
	RegisterFactory("org.openrewrite.golang.tree.G$CompilationUnit", func() any { return &tree.CompilationUnit{} })
	RegisterFactory("org.openrewrite.golang.tree.G$GoStatement", func() any { return &tree.GoStmt{} })
	RegisterFactory("org.openrewrite.golang.tree.G$Defer", func() any { return &tree.Defer{} })
	RegisterFactory("org.openrewrite.golang.tree.G$Send", func() any { return &tree.Send{} })
	RegisterFactory("org.openrewrite.golang.tree.G$Goto", func() any { return &tree.Goto{} })
	RegisterFactory("org.openrewrite.golang.tree.G$Fallthrough", func() any { return &tree.Fallthrough{} })
	RegisterFactory("org.openrewrite.golang.tree.G$Composite", func() any { return &tree.Composite{} })
	RegisterFactory("org.openrewrite.golang.tree.G$KeyValue", func() any { return &tree.KeyValue{} })
	RegisterFactory("org.openrewrite.golang.tree.G$SliceExpr", func() any { return &tree.Slice{} })
	RegisterFactory("org.openrewrite.golang.tree.G$MapType", func() any { return &tree.MapType{} })
	RegisterFactory("org.openrewrite.golang.tree.G$Channel", func() any { return &tree.Channel{} })
	RegisterFactory("org.openrewrite.golang.tree.G$FuncType", func() any { return &tree.FuncType{} })
	RegisterFactory("org.openrewrite.golang.tree.G$StructType", func() any { return &tree.StructType{} })
	RegisterFactory("org.openrewrite.golang.tree.G$InterfaceType", func() any { return &tree.InterfaceType{} })
	RegisterFactory("org.openrewrite.golang.tree.G$TypeList", func() any { return &tree.TypeList{} })
	RegisterFactory("org.openrewrite.golang.tree.G$TypeDecl", func() any { return &tree.TypeDecl{} })
	RegisterFactory("org.openrewrite.golang.tree.G$MultiAssignment", func() any { return &tree.MultiAssignment{} })
	RegisterFactory("org.openrewrite.golang.tree.G$CommClause", func() any { return &tree.CommClause{} })
	RegisterFactory("org.openrewrite.golang.tree.G$IndexList", func() any { return &tree.IndexList{} })
