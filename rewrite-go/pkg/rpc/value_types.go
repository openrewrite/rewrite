...
func init() {
	...
	RegisterValueType(reflect.TypeOf((*tree.Union)(nil)), "org.openrewrite.golang.tree.Go$Union")
	RegisterValueType(reflect.TypeOf((*tree.UnderlyingType)(nil)), "org.openrewrite.golang.tree.Go$UnderlyingType")
	...
	RegisterFactory("org.openrewrite.golang.tree.Go$Union", func() any { return &tree.Union{ID: uuid.New()} })
	RegisterFactory("org.openrewrite.golang.tree.Go$UnderlyingType", func() any { return &tree.UnderlyingType{ID: uuid.New()} })
