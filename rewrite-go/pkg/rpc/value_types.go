...
func init() {
	...
	RegisterValueType(reflect.TypeOf(golang.Conversion{}), "org.openrewrite.golang.marker.Conversion")
	...
	RegisterFactory("org.openrewrite.golang.marker.Conversion", func() any { return golang.Conversion{} })
